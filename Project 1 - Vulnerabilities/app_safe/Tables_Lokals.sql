...
INSERT INTO `review`(`review_id`,`user_id_fk`,`ap_id_fk`,`review_score`,`comment`) VALUES (1,15,10,10,'A great stay, thank you!');
INSERT INTO `review`(`review_id`,`user_id_fk`,`ap_id_fk`,`review_score`,`comment`) VALUES (2,16,14,10,'The location was great, very nice!');
...
INSERT INTO `review`(`review_id`,`user_id_fk`,`ap_id_fk`,`review_score`,`comment`) VALUES (7,22,11,9,'The host was lovely, really felt like home.');
INSERT INTO `review`(`review_id`,`user_id_fk`,`ap_id_fk`,`review_score`,`comment`) VALUES (8,23,12,9,'Amazing and so cozy, loved my stay!');
