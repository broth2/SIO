...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
  if ($_SESSION['loggedin'] and !empty($_POST["cardnum"])) {
    echo $_POST["cardnum"];
  ...
  $date = date("Y-m-d", strtotime($date_arr[2].$date_arr[1].$date_arr[0]));  $dayz = $_POST["nmr_nts"];
              ...
              <div class=\"container\">
                ...
                ?>
                  ...
                  <select class="form-control form-control-sm numeroDePessoas" name="nmr" style="width: 64.5%;">
                    <option value="apartamento">Numero de pessoas</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
...
";
                  ...
                  echo"
                  <p><a href=\"#\" class=\"btn btn-primary px-4 py-3\"  style=\"width: 85%; border-radius: 0.2rem;\">Para reservar tem de estar registado! </a></p>
                  ";
                  {
                ...
                <div class="modal fade" id="pagamentoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <?php
                        $numNoites = (int)$_POST["nmr_nts"];

                        echo"
                        $numnoites
                        <p style=\"width: 50%; float: left; font-size: larger;\">Total : ".( $numNoites * $pricePerNight)." </p>";
                      ?>
                      </div>

                      <div class="modal-footer" style="padding: 15px 15px 15px 15px; justify-content: center;">
                        <button type="submit" name="submit" value="Submit" class="btn btn-primary" id="confirmar">Confirmar</button>
                      </div>
                    </div>
                  </div>
                </div>
